	...
	public class Test {
		public static void main(String[] args) throws InterruptedException {
			// TODO Auto-generated method stub
					...
					cd.findElement(By.id("Contacts_editView_fieldName_firstname")).sendKeys("Kalpana");
					Thread.sleep(2000);
					
					cd.findElement(By.id("Contacts_editView_fieldName_lastname")).sendKeys("Waghmare");
					Thread.sleep(2000);
					
					cd.findElement(By.id("Contacts_editView_fieldName_phone")).sendKeys("1234567890");
					Thread.sleep(2000);
					
					cd.findElement(By.id("Contacts_editView_fieldName_mobile")).sendKeys("9999999999");
					Thread.sleep(2000);
					
					cd.findElement(By.id("Contacts_editView_fieldName_homephone")).sendKeys("8888888888");
					Thread.sleep(2000);
					
					cd.findElement(By.id("Contacts_editView_fieldName_otherphone")).sendKeys("7777777777");
					Thread.sleep(2000);
					...
					cd.findElement(By.id("Contacts_editView_fieldName_email")).sendKeys("kw010@gmail.com");
					Thread.sleep(2000);
					...
					Thread.sleep(2000);
					cd.findElement(By.id("Contacts_editView_fieldName_secondaryemail")).sendKeys("kw010@gmail.com");
					Thread.sleep(2000);
				   ...
				   cd.findElement(By.cssSelector("input[id='Contacts_editView_fieldName_donotcall']")).click();		
					...
					Thread.sleep(2000);
					cd.findElement(By.name("otherstreet")).sendKeys("Dharashiv");
					Thread.sleep(2000);
					js.executeScript("window.scrollBy(0,70)");
					...
					Thread.sleep(2000);
			 		cd.findElement(By.xpath("//textarea[@name='description']")).sendKeys("java is easy");
					...
					cd.findElement(By.id("Leads_editView_fieldName_firstname")).sendKeys("Kalpana");
					Thread.sleep(2000);
					
					cd.findElement(By.id("Leads_editView_fieldName_lastname")).sendKeys("Waghmare");
					Thread.sleep(2000);
					...
					cd.findElement(By.id("Leads_editView_fieldName_mobile")).sendKeys("9999999999");
					Thread.sleep(2000);
					...
					cd.findElement(By.id("Leads_editView_fieldName_email")).sendKeys("kw010@gmail.com");
					Thread.sleep(2000);
					...
					cd.findElement(By.id("Leads_editView_fieldName_noofemployees")).sendKeys("010");
					Thread.sleep(2000);
					
					cd.findElement(By.id("Leads_editView_fieldName_secondaryemail")).sendKeys("kw010@gmail.com");
					Thread.sleep(2000);
				    ...
				    cd.findElement(By.id("Accounts_editView_fieldName_accountname")).sendKeys("Kalpana");
				    Thread.sleep(2000);

				    cd.findElement(By.id("Accounts_editView_fieldName_website")).sendKeys("Q-spiders.com");
				    Thread.sleep(2000);
				    
				    cd.findElement(By.id("Accounts_editView_fieldName_phone")).sendKeys("7777777777");
				    Thread.sleep(2000);
				    ...
				    cd.findElement(By.id("Accounts_editView_fieldName_email1")).sendKeys("kw010@gmail.com");
				    Thread.sleep(2000);
					
					cd.findElement(By.id("Accounts_editView_fieldName_email2")).sendKeys("kw010@gmail.com");
					Thread.sleep(2000);
